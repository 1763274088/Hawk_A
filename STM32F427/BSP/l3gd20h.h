...
#define L3GD20_SPI_MOSI_AF               

#define L3GD20_SPI_CS_PIN                GPIO_Pin_13                  /* PC.13 */
#define L3GD20_SPI_CS_GPIO_PORT          GPIOC                       /* GPIOC */
#define L3GD20_SPI_CS_GPIO_CLK           RCC_AHB1Periph_GPIOC

#define L3GD20_SPI_INT1_PIN              GPIO_Pin_0                  /* PB.00 */
#define L3GD20_SPI_INT1_GPIO_PORT        GPIOB                       /* GPIOB */
#define L3GD20_SPI_INT1_GPIO_CLK         RCC_AHB1Periph_GPIOB
#define L3GD20_SPI_INT1_EXTI_LINE        EXTI_Line0
#define L3GD20_SPI_INT1_EXTI_PORT_SOURCE EXTI_PortSourceGPIOB
